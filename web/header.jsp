...
<%
    ...
    try {
        ...
        tipoUsuario = context.getAttribute("tipoUsuario").toString();
    } catch(Exception e) {
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" id="addEspectaculoFaborito" href="addEspectaculoFaborito.jsp">Añadir espectaculo como favorito</a></li>
                    ...
                    <li><a class="dropdown-item" id="consultaEspectaculoFinalizado" href="consultarEspectaculoFinalizado.jsp">Consultar Finalizados</a></li>
                    <li><a class="dropdown-item" id="FinalizarEspectaculo" href="FinalizarEspectaculo.jsp">Finalizar Espectaculo</a></li>
