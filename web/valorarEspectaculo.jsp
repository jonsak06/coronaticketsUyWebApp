...
<html>
    ...
    <body>
        ...
        <div class="box">
            ...
            <%
                out.println("<form action=\"valorarEspectaculoBackEnd\">");
                ...
                Gson gson = new Gson();
                String jsonNombresEspsFab = gson.toJson(nombresEspsVal);
                String jsonNombresEspsNoFab = gson.toJson(nombresEspsNoVal);
                for (DtEspectaculo e : esps) {
                    ...
                    out.print("<p> valoracion promedio: " + e.getValoracionPromedio() + "</p>");
                    if (nombresEspsVal.contains(e.getNombre())) {

                        out.print("<label><input type=\"number\" value=\"none\" name=\""+e.getNombre()+"\" disabled> Valoracion</label><br>");
                        
                        

                    } else {
                        out.print("<label><input type=\"number\" value=\"none\" name=\""+e.getNombre()+"\"> Valoracion</label><br>");
                    }
