 ...
 * @author tecnologo
 */
@WebServlet(urlPatterns = {"/dejarDeSeguirUsuarioBackEnd"})
public class dejarDeSeguirUsuarioBackEnd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (contexto.getAttribute("tipoUsuario").toString().equals("Espectador")) {
            ...
            Fabrica.getCrlUsuarios().dejarDeSeguirUsuarioEs(nickname, seguido);
        }
        ...
        request.setAttribute("dejadoSUsu", true);
