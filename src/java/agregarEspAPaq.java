 ...
 * @author julio
 */
@WebServlet(urlPatterns = {"/agregarEspAPaq"})
public class agregarEspAPaq extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String paquete =  request.getParameter("nomPaq");
            iPaquetes ip = Fabrica.getCtrlPaquetes();
            ip.confirmarAgregadoEspectaculo(espectaculo, paquete);
